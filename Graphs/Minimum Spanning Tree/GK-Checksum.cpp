/*
Ah, so the intuition is that you take any cycle and assign it a correct value. 
Now, since every row and column has exactly even-numbered contributions there, 
I can flip every member's value in this circle without disturbing the R and C.
*/
